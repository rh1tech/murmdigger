/*
 * rp2350_snd.c - RP2350 I2S Sound Backend for Digger
 *
 * Uses the I2S DMA driver to output audio generated by Digger's
 * software sound engine (getsample()).
 *
 * Audio is generated and submitted from Core 0 during each game frame.
 * The I2S driver uses DMA ping-pong on DMA_IRQ_1 for continuous playback.
 */
